cloudo.onInit(function () {
	...
	var cloudoPackagesConfig = {
		patterns: {
			"cloudo-plugin-js": {
				url: cloudo.translateURL("dorado/cloudo/plugin/res/${fileName}.js"),
				contentType: "text/javascript", charset: "UTF-8", mergeRequests: false
			},
			"cloudo-plugin-css": {
				url: cloudo.translateURL("dorado/cloudo/plugin/res/${fileName}.css"),
	...
	function registerCloudoPackages() {
		var url = cloudo.translateURL("dorado/cloudo/plugin/manager/packages"),
