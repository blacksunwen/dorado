cloudo.onInit(function(){
    var cloudoPackagesConfig = {
            patterns: {
                "cloudo-plugin-js": {
                    url:">dorado/cloudo/plugin/res/${fileName}.js",
                    contentType: "text/javascript", charset: "UTF-8", mergeRequests: false
                },
                "cloudo-plugin-css": {
                    url:">dorado/cloudo/plugin/res/${fileName}.css",
    ...
    function registerCloudoPackages() {
        var url = ">dorado/cloudo/plugin/manager/packages",
        ...
        packageDefs = data.def; bootPackages = data.boot;
        if (packageDefs) {
