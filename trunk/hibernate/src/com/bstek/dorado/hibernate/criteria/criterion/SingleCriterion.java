...
@XmlNode(nodeName = "SingleCriterion")
public class SingleCriterion extends SingleProperyCriterion {
	...
	public static enum OP {
		...
		like{
			...
			public Criterion criterion(String propertyName, Object value){
				return Restrictions.like(propertyName, String.valueOf(value), MatchMode.START);
			}
		},likeEnd{
			public String toString(){
				return "%like";
			...
			public Criterion criterion(String propertyName, Object value){
				return Restrictions.like(propertyName, String.valueOf(value), MatchMode.END);
			}
		},likeAnyWhere{
			public String toString(){
				return "%like%";
			...
			public Criterion criterion(String propertyName, Object value){
				return Restrictions.like(propertyName, String.valueOf(value), MatchMode.ANYWHERE);
			}
		},
		...
		ilike{
			...
			public Criterion criterion(String propertyName, Object value){
				return Restrictions.ilike(propertyName, String.valueOf(value), MatchMode.START);
			}
		},ilikeEnd{
			public String toString(){
				return "%ilike";
			...
			public Criterion criterion(String propertyName, Object value){
				return Restrictions.ilike(propertyName, String.valueOf(value), MatchMode.END);
			}
		},ilikeAnyWhere{
			public String toString(){
				return "%ilike%";
			...
			public Criterion criterion(String propertyName, Object value){
				return Restrictions.ilike(propertyName, String.valueOf(value), MatchMode.ANYWHERE);
			}
		};
	...
	@XmlProperty(parser="dorado.singleCriterionOpParser")
	public OP getOp() {
		return op;
	}
