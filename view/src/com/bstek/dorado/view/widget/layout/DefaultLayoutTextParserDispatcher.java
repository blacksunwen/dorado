 ...
 * @since Apr 3, 2008
 */
public class DefaultLayoutTextParserDispatcher extends DispatchableTextParser {
	...
	protected TextParser findSubParser(String constraint,
		...
		if (info != null) {
			return (TextParser) info.getParser();
		}
		else {
	...
	public Object parse(char[] charArray, TextParseContext context)
		...
		if (info != null) {
			...
			TextParser layoutParser = (TextParser) info.getParser();
