 ...
 * @since Feb 26, 2008
 */
public class DirectW3cHtml4ViewResolver extends AbstractTextualResolver {
	private VelocityHelper velocityHelper;
	private String templateFile = "home:w3c-html4-template.html";
	private String uriPrefix;
	private int uriPrefixLen;
	private String uriSuffix;
	private int uriSuffixLen;

	public DirectW3cHtml4ViewResolver() {
	 ...
	 * @throws Exception
	 */
	protected ViewConfigManager getViewConfigManager() throws Exception {
