 ...
 */
dorado.touch.CheckBox = $extend(dorado.widget.AbstractDataEditor, /** @scope dorado.widget.CheckBox.prototype */
{
    ...
    createDom:function () {
        ...
        if (checkBox._iconOnly) {
            ...
            jQuery(dom).addClassOnHover(checkBox._className + "-hover", null,
                function () {
