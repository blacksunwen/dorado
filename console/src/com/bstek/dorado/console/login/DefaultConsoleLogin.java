 ...
 * 
 */
public class DefaultConsoleLogin implements ConsoleLogin, InitializingBean {
	...
	public boolean validate(String name, String password) {
		...
		ctx.setAttribute(DoradoContext.SESSION,
				Constants.S_DORADO_CONSOLE_LOGIN_SUCCESS, Boolean.valueOf(v));
	...
	public boolean isLogin(HttpServletRequest request) {
		...
		try {
			loginStatus = Boolean.valueOf((Boolean) request.getSession()
					.getAttribute(Constants.S_DORADO_CONSOLE_LOGIN_SUCCESS));
		} catch (Exception e) {
		}
		return loginStatus;
	}
