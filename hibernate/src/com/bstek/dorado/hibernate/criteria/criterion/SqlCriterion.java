...
public class SqlCriterion extends BaseCriterion {
	...
	public Criterion toHibernate(Object parameter, SessionFactory sessionFactory, 
		...
		List<org.hibernate.type.Type> types = new ArrayList<org.hibernate.type.Type>(parameters.size());
		for (SqlCriterion.Parameter param: parameters) {
			...
			org.hibernate.type.Type type = sessionFactory.getTypeHelper().basic(hibernateTypeName);
		...
		org.hibernate.type.Type[] typeArray = types.toArray(new org.hibernate.type.Type[parameters.size()]);
