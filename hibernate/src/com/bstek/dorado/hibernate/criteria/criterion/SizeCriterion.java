...
@XmlNode(nodeName="SizeCriterion")
public class SizeCriterion extends SingleProperyCriterion {
	...
	@XmlProperty(parser="dorado.sizeCriterionOpParser")
	public OP getOp() {
		return op;
	}
	...
	public Criterion toHibernate(Object parameter, SessionFactory sessionFactory, 
		...
		if (sizeObj != null) {
			Integer size = (Integer)transformer.getValueFromParameter(parameter, "Integer", sizeObj);
			if (size != null) {
