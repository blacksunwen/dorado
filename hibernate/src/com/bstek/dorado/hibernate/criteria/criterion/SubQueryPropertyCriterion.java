...
@XmlNode(nodeName="SubQueryPropertyCriterion")
public class SubQueryPropertyCriterion extends SingleProperyCriterion {
	...
	public static enum OP {
		...
		public abstract Criterion criterion(String propertyName, DetachedCriteria dc);
	...
	@XmlProperty(parser="dorado.subQueryPropertyCriterionOpParser")
	public OP getOp() {
		return op;
	}
	...
	public Criterion toHibernate(Object parameter, SessionFactory sessionFactory, 
		...
		DetachedCriteria dc = transformer.toHibernate(innerCriteria, parameter, sessionFactory);
